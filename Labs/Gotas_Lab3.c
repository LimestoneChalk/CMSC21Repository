...
int main (void){
    ...
    while(!clear) //clear value serves as boolean to see if user inputted a proper value
    {
    ...
    do {
        ...
        //how it works: 496 is divided by 10 -> 9.6, then the remainder 6 is assigned to the digit value. This continues down until the last digit.
